...
const SurveyController = require(path.join(
  __dirname,
  '..',
  'controllers',
  'SurveyController'
...
router.patch('/verifyStatus/:id', SurveyController.verifyStatus);
router.patch('/stopStatus/:id', SurveyController.stopStatus);
